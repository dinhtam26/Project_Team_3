                ...
                <div class="">
                    <div class="container">
                        ...
                        <form action="" method="post">
                            ...
                            <!-- Khu vực Parent_cate-id -->
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mt-3 mb-3">
                                        <span class="form-label">Parent_id</span>
                                        <input type="text" name="parent_id" class="form-control" value="<?php echo isset($_SESSION['data']) ? $_SESSION['data'] : "" ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
