<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Update Color</h6>
        </div>
        <div class="card-body">
            <div class="">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mt-3 mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" value="<?= isset($itemColor['name']) ? $itemColor['name'] : "" ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3 mb-3">
                                        <a href="<?= ROOT_URL_ADMIN ?>?act=color" class="btn btn-secondary">Quay lại</a>
