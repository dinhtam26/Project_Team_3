        ...
        <div class="footer__bottom">
            ...
            <div class="footer__socials">
                <a href="#!" class="footer__social-link footer__social-link--facebook">
                    <img src="<?= ROOT_ASSET_URL ?>client/assets/icons/facebook.svg" alt="" class="footer__social-icon" />
                </a>
                <a href="#!" class="footer__social-link footer__social-link--youtube">
                    <img src="<?= ROOT_ASSET_URL ?>client/assets/icons/youtube.svg" alt="" class="footer__social-icon" />
                </a>
                <a href="#!" class="footer__social-link footer__social-link--tiktok">
                    <img src="<?= ROOT_ASSET_URL ?>client/assets/icons/tiktok.svg" alt="" class="footer__social-icon" />
                </a>
                <a href="#!" class="footer__social-link footer__social-link--twitter">
                    <img src="<?= ROOT_ASSET_URL ?>client/assets/icons/twitter.svg" alt="" class="footer__social-icon" />
                </a>
                <a href="#!" class="footer__social-link footer__social-link--linkedin">
                    <img src="<?= ROOT_ASSET_URL ?>client/assets/icons/linkedin.svg" alt="" class="footer__social-icon" />
                </a>
            </div>
        </div>
    </div>
